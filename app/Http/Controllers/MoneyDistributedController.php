...
class MoneyDistributedController extends Controller
{
    ...
    public function index()
    {
      ...
      $donor_money = $this->cal_excess_amount(DB::table('register_donor_money')->get()[0]->amount, (int)100000000);  

      //echo $donor_money; 
      if(gettype($donor_money)=== 'integer'){

        $remaining_amount = $this->cal_payments($donor_money, 5000000);
